...
export default class Room {
    ...
    sendState() {
        Object.keys(this.clients).forEach((id) => {
            try {
                let gameView = this.games[id].getViewObject();
                gameView.leaderboardPlace = this.getLeaderboardPos(id);
                this.clients[id].emit('gameView', gameView);
                ...
                Object.keys(this.games).forEach((id) => {
                    opponents.push({
                        ...
                        leaderboardPlace: this.getLeaderboardPos(id),
                    });
                });
