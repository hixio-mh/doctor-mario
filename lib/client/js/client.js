...
// why: https://coderwall.com/p/vmkk6a/how-to-make-the-canvas-not-look-like-crap-on-retina
matrixCanvas.width = 400*2;
matrixCanvas.height= 760*2;
matrixCanvas.style.width = "400px";
matrixCanvas.style.height= "760px";
matrixContext.scale(2,2)
...
socket.on('gameView', (gameView) => {
    ...
    Drawing.drawGameElements(0, 0, matrixCanvas.width/2, matrixCanvas.height/2, gameView.matrix, gameView.garbageQueueLength, username, gameView.leaderboardPlace, matrixContext);
